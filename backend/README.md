...
## Project Structure
    ...
    ├── testapiautoteammem_115287  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_115287`
...
2. Clone this repo and `cd testapiautoteammem_115287`
